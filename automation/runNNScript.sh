...
#Change this to your directory your Makefile is in for us with crontabs
...
make runNN > /home/pnap32032/automation/logs/neural-network-logs/"$(date +"%Y_%m_%d_%I_%M_%p").txt" 
...
mailx -s "NN Ran" jacobmask@yahoo.com < /home/pnap32032/automation/logs/neural-network-logs/"$(date +"%Y_%m_%d_%I_%M_%p").txt"
